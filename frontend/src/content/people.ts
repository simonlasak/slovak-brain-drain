...
const en: Section4Content = {
  ...
  closing: [
    'Three of the nine explain more than the other six: two because they left for reasons the pattern does not cover, and one because he came back.',
    ...
    'Ján Tkáč is the only one of the nine who came home, and the order of events matters more than the fact of it. He left at twenty-five for postdoctoral work that ran through Linköping and Lund in Sweden and through Oxford, and he has been at the Institute of Chemistry of the Slovak Academy of Sciences since 2009. The European Research Council starting grant arrived four years after that: ELENA, from the 2012 call, an EU contribution of 1,155,970 euros running from 2013 to 2017. It did not bring him back. It found him already back, and built a glycomics group around him.',
    'That is the shape of the thing. One left because a system failed him, one left for reasons Slovakia never controlled, and one came home on ordinary terms, years before any grant rewarded him for it. The other six finished their Slovak degrees and went.',
  ],
